        ...
        <div className="container-xl relative z-10">
          <div className="mx-auto max-w-4xl text-center text-white">
            ...
            <p className="text-xl leading-relaxed text-white/90 md:text-2xl">
              ...
              generations through innovative post-tensioning solutions and
              advanced problem-solving engineering methodologies across East
              Africa.
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              ...
              <div className="card group transition-all duration-300 hover:shadow-lg">
                <div className="card-body space-y-6 text-center">
                  ...
                  <p className="leading-relaxed text-muted">
                    Over a decade of successfully overcoming construction
                    challenges and delivering solutions across diverse sectors
        ...
        <div className="container-xl">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-12 text-xl leading-relaxed text-muted">
              We deliver reliable construction solutions with consistent
              quality, safety practices, and environmental consideration built
              into every project.
            </p>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div className="card group transition-all duration-300 hover:shadow-lg">
              <div className="card-body space-y-6 text-center">
                ...
                <p className="leading-relaxed text-muted">
                  To solve East Africa&apos;s most pressing infrastructure
                  challenges through innovative post-tensioning
                  expertise—enabling developers to overcome limitations, build
                  higher, span farther, and complete projects faster while
            ...
            <div className="card group transition-all duration-300 hover:shadow-lg">
              <div className="card-body space-y-6 text-center">
                ...
                <p className="leading-relaxed text-muted">
                  To solve construction challenges through innovative
                  post-tensioning technology, expert problem-solving approaches,
                  and collaborative partnerships, creating value for our clients
                  while addressing Ethiopia&apos;s infrastructure development
                  needs.
                </p>
              </div>
            </div>
            ...
            <div className="card group transition-all duration-300 hover:shadow-lg">
              <div className="card-body space-y-6 text-center">
                ...
                <p className="leading-relaxed text-muted">
                  ...
                  innovative approaches to challenges, and collaborative
                  solutions guide every aspect of our work, ensuring we deliver
                  superior results while maintaining the highest ethical and
